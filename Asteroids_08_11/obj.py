...
class Asteroid(pygame.sprite.Sprite):
    ...
    def move(self):
        self.location[0] += 5*self.directionX
        self.location[1] += 5*self.directionY
...
class Ship(pygame.sprite.Sprite):
    ...
    def check_collision(self, asteroid):
        ...
        if self.location[0] + self.image.get_width() // 2 > asteroid.location[0]\
           and self.location[0] + self.image.get_width() //2 < asteroid.location[0] + asteroid.image.get_width()\
           and self.location[0] + self.image.get_width() // 2 > asteroid.location[0]\
           and self.location[1] + self.image.get_height() // 2 > asteroid.location[1]\
           and self.location[1] + self.image.get_height() //2 < asteroid.location[1] + asteroid.image.get_height():
            return True
...
class Bullet(pygame.sprite.Sprite):
    ...
    def check_collision(self, asteroid):
        if self.location[0] + self.image.get_width() // 2 > asteroid.location[0] and self.location[0] < asteroid.location[0] + asteroid.image.get_width() \
           and self.location[1] + self.image.get_height() // 2 > asteroid.location[1] and self.location[1] < asteroid.location[1] + asteroid.image.get_height():
            return True
