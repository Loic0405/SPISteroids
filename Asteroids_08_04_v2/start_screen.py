...
def showStartScreen():
    ...
    while True:
        ...
        DISPLAYSURF.blit( pygame.transform.rotate(battleShip.image, battleShip.angle), battleShip.blit_location )
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if event.key == K_LEFT:
                    ...
                    battleShip.acceleration = [sin(pi * battleShip.angle / 180), cos(pi * battleShip.angle / 180)]
