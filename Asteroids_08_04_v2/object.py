...
class Ship(pygame.sprite.Sprite):
    ...
    def Move(self):
        ...
        self.blit_location[0] = self.location[0] - abs(sin(pi*self.angle/90)*self.image.get_width()/sqrt(8))
        self.blit_location[1] = self.location[1] - abs(sin(pi*self.angle/90)*self.image.get_width()/sqrt(8))
